...
import (
	...
	"genesis_test_case/src/pkg/repository/crypto/banners"
	"genesis_test_case/src/pkg/repository/crypto/exchangers"
	"genesis_test_case/src/pkg/repository/mailing"
	"genesis_test_case/src/pkg/repository/storage"
